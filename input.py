...
class Input():
  ...
  def define_parser(self):
    ...
    #optional.add_argument('-a', '--alpha', dest = 'alpha', default = -1.0, type = float, help = 'scaling factor for mvalues. Default is to learn value.')
  ...
  def read_parser(self, args):
    ...
    self.out = args.out
    self.num = args.num
    self.alpha = [-1.0 for i in range(self.k)]
